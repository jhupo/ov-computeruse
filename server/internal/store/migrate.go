...
func (s *Store) migrate(ctx context.Context) error {
	stmts := []string{
		...
		`CREATE TABLE IF NOT EXISTS codex_sessions (agent_id TEXT NOT NULL REFERENCES agents(id), id TEXT NOT NULL, project_id TEXT, title TEXT, path TEXT, updated_at TIMESTAMPTZ, size_bytes BIGINT, content_sha256 TEXT, indexed_at TIMESTAMPTZ NOT NULL DEFAULT now(), PRIMARY KEY(agent_id, id))`,
