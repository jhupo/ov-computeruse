...
func (s *Store) migrate(ctx context.Context) error {
	stmts := []string{
		...
		`ALTER TABLE users ADD COLUMN IF NOT EXISTS sub2api_access_token TEXT`,
		`ALTER TABLE users ADD COLUMN IF NOT EXISTS sub2api_refresh_token TEXT`,
		`ALTER TABLE users ADD COLUMN IF NOT EXISTS sub2api_token_type TEXT`,
		`ALTER TABLE users ADD COLUMN IF NOT EXISTS sub2api_token_expires_at TIMESTAMPTZ`,
		`ALTER TABLE users ADD COLUMN IF NOT EXISTS sub2api_balance NUMERIC`,
		`ALTER TABLE users ADD COLUMN IF NOT EXISTS sub2api_synced_at TIMESTAMPTZ`,
