...
Build-time injection only includes client package metadata. Database URLs, Redis URLs, user keys, deployment tokens, and runtime tokens are provided as runtime secrets/environment variables.
